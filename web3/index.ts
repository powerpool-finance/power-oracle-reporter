...
class PowerOracleWeb3 implements IPowerOracleWeb3 {
  ...
  async getStakeAndClaimStatus(routerContract) {
    ...
    const claimParams = await connector.methods.unpackClaimParams(c.claimParams).call({});
  ...
  async getReadyToExecuteRounds() {
    ...
    roundInited.push({ returnValues: { key: '0x87DE78114A8BD3FCA089F9719D167EC4510450692C9736ECF125165E93EA05CE' } });
  ...
  async getGasPriceOptions(gasPriceMul) {
    ...
    console.log('maxFeePerGas', utils.weiToGwei(maxFeePerGas), 'maxPriorityFeePerGas', utils.weiToGwei(maxPriorityFeePerGas));
